...
final class Transformers {
  ...
  public static String tModel(ApiClient apiClient, Object origin) {
    ...
    if (origin == null) {
      ...
      model = JsonSerializable.toJsonString(origin);
      model = model.replace("\"", "");
    } else {
  ...
  public static List<Content> tContents(ApiClient apiClient, Object contents) {
    ...
    if (contents instanceof String) {
      ...
      return JsonSerializable.gson.fromJson((JsonElement) contents, TYPE_TOKEN.getType());
    }
  ...
  public static Content tContent(ApiClient apiClient, Object content) {
    if (content == null) {
      ...
      return JsonSerializable.gson.fromJson((JsonElement) content, Content.class);
    }
  ...
  public static Schema tSchema(ApiClient apiClient, Object origin) {
    if (origin == null) {
      ...
      return JsonSerializable.gson.fromJson((JsonElement) origin, Schema.class);
    }
  ...
  public static SpeechConfig tSpeechConfig(ApiClient apiClient, Object speechConfig) {
    if (speechConfig == null) {
      ...
      return JsonSerializable.gson.fromJson((JsonElement) speechConfig, SpeechConfig.class);
    }
  ...
  public static List<Tool> tTools(ApiClient apiClient, Object origin) {
    if (origin == null) {
      ...
      return JsonSerializable.gson.fromJson((JsonElement) origin, List.class);
    }
  ...
  public static Tool tTool(ApiClient apiClient, Object origin) {
    if (origin == null) {
      ...
      return JsonSerializable.gson.fromJson((JsonElement) origin, Tool.class);
    }
  ...
  public static String tCachedContentName(ApiClient apiClient, Object origin) {
    if (origin == null) {
      ...
      String cachedContentName = JsonSerializable.toJsonString(origin);
